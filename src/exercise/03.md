...
- JSX is converted into the React API (which is converted into DOM management)
- JSX needs to be code compiled (Babel) and runs during runtime
- JSX scripts need to be told where to compile in 'type'.
- JSX assigns HTML code to variables
- JSX Rules
    - Must return a single root element
    - Tags must all be closed
    - camelCase 
- JSX curly brackets to interpolate (objects are {{}})
